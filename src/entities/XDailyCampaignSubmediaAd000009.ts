...
@Index(
  "submedia_AD000009_campaignCode_submediaCode_registeredAt",
...
@Entity("x_daily_campaign_submedia_AD000009", { schema: "mecrosspro" })
export class XDailyCampaignSubmediaAd000009 {
