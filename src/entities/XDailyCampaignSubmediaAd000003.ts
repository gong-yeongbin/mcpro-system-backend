...
@Index(
  "submedia_AD000003_campaignCode_submediaCode_registeredAt",
...
@Entity("x_daily_campaign_submedia_AD000003", { schema: "mecrosspro" })
export class XDailyCampaignSubmediaAd000003 {
