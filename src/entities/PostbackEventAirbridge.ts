...
@Entity('postback_event_airbridge', { schema: 'mcpro' })
export default class PostbackEventAirbridge {
  ...
  @Column('tinyint', { name: 'isGoalCategoryUnique', nullable: true })
  public isGoalCategoryUnique: number | null;
  ...
  @Column('varchar', { name: 'eventName', nullable: true, length: 255 })
  public eventName: string | null;

  @Column('varchar', { name: 'eventLabel', nullable: true, length: 255 })
  public eventLabel: string | null;

  @Column('float', { name: 'eventValue', nullable: true, precision: 12 })
  public eventValue: number | null;

  @Column('tinyint', { name: 'inAppPurchased', nullable: true })
  public inAppPurchased: number | null;
  ...
  @Column('varchar', { name: 'ad_type', nullable: true, length: 255 })
  public adType: string | null;

  @Column('varchar', { name: 'ad_group', nullable: true, length: 255 })
  public adGroup: string | null;

  @Column('varchar', { name: 'ad_creative', nullable: true, length: 255 })
  public adCreative: string | null;
