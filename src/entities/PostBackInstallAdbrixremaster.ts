...
@Entity('postback_install_adbrixremaster')
export default class PostBackInstallAdbrixremaster {
  ...
  @Column({ name: 'attr_type', type: 'nvarchar', nullable: true })
  attr_type: string;
  ...
  @Column({ name: 'market_install_btn_clicked', type: 'nvarchar', nullable: true })
  market_install_btn_clicked: string;

  @Column({ name: 'app_install_start', type: 'nvarchar', nullable: true })
  app_install_start: string;

  @Column({ name: 'app_install_completed', type: 'nvarchar', nullable: true })
  app_install_completed: string;

  @Column({ name: 'app_first_open', type: 'nvarchar', nullable: true })
  app_first_open: string;

  @Column({ name: 'seconds_gap', type: 'nvarchar', nullable: true })
  seconds_gap: string;
  ...
  @ManyToOne(() => Campaign, (campaign) => campaign.postBackInstallAdbrixremaster)
