...
@Index(
  "submedia_AD000006_campaignCode_submediaCode_registeredAt",
...
@Entity("x_daily_campaign_submedia_AD000006", { schema: "mecrosspro" })
export class XDailyCampaignSubmediaAd000006 {
