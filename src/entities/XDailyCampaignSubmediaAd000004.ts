...
@Index(
  "submedia_AD000004_campaignCode_submediaCode_registeredAt",
...
@Entity("x_daily_campaign_submedia_AD000004", { schema: "mecrosspro" })
export class XDailyCampaignSubmediaAd000004 {
