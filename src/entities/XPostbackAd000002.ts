...
@Index(
  "x_postback__a_d000002_campaign_code_registered_at_event_name",
  ["campaignCode", "registeredAt", "eventName"],
  {}
)
@Entity("x_postback_AD000002", { schema: "mecrosspro" })
export class XPostbackAd000002 {
  ...
  @Column("varchar", { name: "packageName", nullable: true, length: 300 })
