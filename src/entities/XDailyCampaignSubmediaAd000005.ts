...
@Index(
  "submedia_AD000005_campaignCode_submediaCode_registeredAt",
...
@Entity("x_daily_campaign_submedia_AD000005", { schema: "mecrosspro" })
export class XDailyCampaignSubmediaAd000005 {
