...
@Entity('postback_event_nswitch', { schema: 'mcpro' })
export default class PostbackEventNswitch {
  ...
  @Column('varchar', { name: 'nsw_event_id', nullable: true, length: 255 })
  nsw_event_id: string | null;

  @Column('varchar', { name: 'nsw_event_price', nullable: true, length: 255 })
  nsw_event_price: string | null;

  @Column('varchar', { name: 'nsw_event_time', nullable: true, length: 255 })
  nsw_event_time: string | null;
