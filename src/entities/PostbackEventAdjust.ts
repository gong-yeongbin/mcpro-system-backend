...
@Entity('postback_event_adjust', { schema: 'mcpro' })
export default class PostbackEventAdjust {
  @PrimaryGeneratedColumn({ type: 'bigint', name: 'idx' })
  idx: string;

  @Column('varchar', { name: 'event_token', nullable: true, length: 255 })
  ...
  @Column('varchar', { name: 'created_at2', nullable: true, length: 255 })
  ...
  @Column('varchar', { name: 'revenue_float', nullable: true, length: 255 })
  revenueFloat: string | null;

  @Column('varchar', { name: 'revenue_usd', nullable: true, length: 255 })
  revenueUsd: string | null;

  @Column('varchar', { name: 'revenue_usd_cents', nullable: true, length: 255 })
  revenueUsdCents: string | null;

  @Column('varchar', { name: 'reporting_revenue', nullable: true, length: 255 })
  reportingRevenue: string | null;
