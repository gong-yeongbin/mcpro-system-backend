...
@Index(
  "submedia_AD000001_campaignCode_submediaCode_registeredAt",
...
@Entity("x_daily_campaign_submedia_AD000001", { schema: "mecrosspro" })
export class XDailyCampaignSubmediaAd000001 {
