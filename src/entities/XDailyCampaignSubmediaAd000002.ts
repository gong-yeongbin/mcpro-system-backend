...
@Index(
  "submedia_AD000002_campaignCode_submediaCode_registeredAt",
...
@Entity("x_daily_campaign_submedia_AD000002", { schema: "mecrosspro" })
export class XDailyCampaignSubmediaAd000002 {
