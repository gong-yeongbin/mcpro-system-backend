...
@Index(
  'submedia_AD000008_campaignCode_submediaCode_registeredAt',
...
@Entity('x_daily_campaign_submedia_AD000008', { schema: 'mecrosspro' })
export class XDailyCampaignSubmediaAd000008 {
